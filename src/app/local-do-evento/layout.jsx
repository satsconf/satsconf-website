export const metadata = {
    ...
    description: "Descubra o local do evento",
    ...
    openGraph:{
      title: "Local do evento Satsconf - O Maior Evento 100% Bitcoin do Brasil",
      description: "Saiba onde vai acontecer a Satsconf",
      type: "website",
      url: "https://www.satsconf.com.br/local-do-evento",
      images: ['https://pbs.twimg.com/profile_banners/1521946346894151682/1710450716/600x200'],
    },
  };
  

export default function LocalEventoLayout({ children }) {
    return (
      <>
      {children}
      </>
