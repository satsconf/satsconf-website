...
const Politica = () => {
  ...
  <div id="politica">
    ...
    <div  className="boxPolitica">
      <h2>Política Privacidade</h2>
      <p>
        A sua privacidade é importante para nós. É política do Satsconf
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site{" "}
        <Link href="https://www.satsconf.com.br/">Satsconf</Link> , e outros
      ...
      <p>
        ...
        informação que o Satsconf oferece no site e com caráter enunciativo, mas
        não limitativo:
      </p>
      <br />
      <ul>
        ...
        <li>
          ...
          (softwares) do Satsconf, de seus fornecedores ou terceiros, para
      ...
      <br />
      <p>Esta política é efetiva a partir de 4 Junho 2024 17:54</p>
    </div>
    </div>
  </div>
  );
